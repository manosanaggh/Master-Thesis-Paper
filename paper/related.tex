...
\note{the title of each subsection should be the same with (1) and
(2). Be consistent and use the same terminology.}
...
Jiang et al. in \cite{inmem} study the behavior of Spark Workloads in
