...
\begin{figure*}[ht!]
    \includegraphics[width=12cm,height=6cm]{./fig/gcs_pr_h1_native.png}
...
\begin{figure*}[ht!]
    \includegraphics[width=12cm,height=6cm]{./fig/gcs_pr_pc_th.png}
...
\begin{figure*}[ht!]
    \includegraphics[width=12cm,height=6cm]{./fig/pr_h1_native.png}
    \caption{Execution time breakdown for PageCache Page Rank TeraHeap
    Spark investigation.}
...
\begin{figure*}[ht!]
    \includegraphics[width=12cm,height=6cm]{./fig/rw_pr_h1_native.png}
...
steady (other). 
\iffalse
Figure \ref{fig:linr_pc_native} shows performance of
single-instance Native Spark running LinearRegression with
...
no changes to Other time. GC time should also remain the same as
H1 remains steady. Figure \ref{fig:gcs_linr_pc_native} and
\ref{fig:rw_linr_pc_native} justify these numbers by showing the number of
minor-major gcs and read traffic to reamain the same. 
\fi
