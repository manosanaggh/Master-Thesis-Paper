...
\title{\Large \bf Overcoming the \note{M}emory \note{B}ound of Big
Data Analytics to \note{I}mprove \note{S}erver \note{T}hroughput
\note{U}sing \note{F}ast \note{S}torage Devices
    \note{jk: About the title: Every begining letter of a word shoud be
    upper-case. The begining letters of linking words (e.g., and, or,
    to) should be lowercase. An alternative title:
    Analysis of Server Throughput For Managed Big Data Analytics
    Workloads.}
}
